...
$dbname = "weatheR"; // Your new database name
...
$sql = "SELECT * FROM store_weather WHERE city = '$city' AND DATE(date) = CURDATE()";
...
if ($result->num_rows > 0) {
    ...
    $insertSql = "INSERT INTO store_weather (city, date, temperature, humidity, pressure, wind, description)
